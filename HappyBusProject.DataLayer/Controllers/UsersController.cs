...
namespace HappyBusProject.Controllers
{
    ...
    {
        private readonly IUsersRepository<UsersViewModel, UserInputModel> _repository;

        public UsersController(IUsersRepository<UsersViewModel, UserInputModel> usersRepository)
        {
